...
public class GetSettings extends BaseCase {
	@Test(summary = "获取小视频配置", expectedResults = "返回结果格式正确", index = 1)
	public void testGetSettings() {
		JSONObject result = g_user.postJsonResp(Constant.FILE_GETSETTINGS);
	...
	public void testGetSettings_Stat1() {
	...
	public void testGetSettings_Stat2() {
	...
	public void testGetSettings_Stat3() {
